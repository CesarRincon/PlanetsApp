...
const PlanetIcon: React.FC<PlanetIconProps> = ({ width = 40, height = 40, color = "#ffff" }) => {
    return (
        <Svg width={width} height={height} viewBox="0 -15.89 87.181 87.181">
            <G transform="translate(-355.391 -272.962)">
                <G>
                    <Circle cx="4.92" cy="4.92" r="4.92" transform="translate(355.391 287.812) rotate(-45)" fill={color} />
                </G>
                <G>
                    <Path
